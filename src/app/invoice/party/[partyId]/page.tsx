                        ...
                        {invoices && invoices.length > 0 ? (
                            <div className="space-y-3">
                                {invoices.sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()).map(invoice => (
                                    <Card key={invoice.id} className="p-4 cursor-pointer hover:bg-secondary/50" onClick={() => router.push(`/invoice/${invoice.id}`)}>
                                        <div className="flex justify-between items-center">
                                            ...
                                            <div className="flex gap-2">
                                                <Button variant="outline" size="icon" onClick={(e) => { e.stopPropagation(); handleShare(invoice.id); }}>
                                                    <Share className="h-4 w-4"/>
                                                </Button>
                                                <Button variant="outline" size="icon" onClick={(e) => { e.stopPropagation(); handlePrint(invoice.id); }}>
